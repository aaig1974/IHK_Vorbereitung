...
using IHK_Vorbereitung.Data;
using IHK_Vorbereitung.Models;
using System.Runtime.InteropServices;

namespace IHK_Vorbereitung.Controllers
{
    public class QuestionsController : Controller
    {
        ...
        {
            return View("Index", await _context.Questions.Where(q => q.Question.Contains(SearchPhrase) || q.Answer.Contains(SearchPhrase)).ToListAsync());
        }
